...
{
    LOG("AsyncMqtt ParseSubScribeOptions Start");
    options.SetTopic(NapiUtils::GetStringPropertyUtf8(GetEnv(), optionsValue, MqttConstant::PARAM_TOPIC));
    options.SetQos(NapiUtils::GetUint32Property(GetEnv(), optionsValue, MqttConstant::PARAM_QOS));
}
}
