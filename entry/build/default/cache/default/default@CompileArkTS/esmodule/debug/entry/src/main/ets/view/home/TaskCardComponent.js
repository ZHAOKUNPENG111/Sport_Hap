...
export class TaskCard extends ViewPU {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            if (isInitialRender) {
                                ViewPU.create(new HealthText(this, {
                                    ...
                                    fontSize: { "id": 16777317, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" }
                                }, undefined, elmtId));
                            }
                            else {
                                this.updateStateVarsOfChildByElmtId(elmtId, {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.borderRadius({ "id": 16777317, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
