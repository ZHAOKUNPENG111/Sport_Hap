...
class GetClientInfo extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("pages/MainPage.ets(61:7)");
            Row.height(THOUSANDTH_1000);
            Row.backgroundColor({ "id": 16777286, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            if (!isInitialRender) {
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Navigation.create();
            Navigation.debugLine("pages/MainPage.ets(62:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/MainPage.ets(63:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/MainPage.ets(64:13)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/MainPage.ets(65:15)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            List.debugLine("pages/MainPage.ets(66:17)");
            if (!isInitialRender) {
                List.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        });
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("pages/MainPage.ets(67:19)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
            ...
            const observedDeepRender = () => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Row.create();
                    Row.debugLine("pages/MainPage.ets(68:21)");
                    if (!isInitialRender) {
                        Row.pop();
                    }
                    ViewStackProcessor.StopGetAccessRecording();
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Blank.create();
                    Blank.debugLine("pages/MainPage.ets(69:23)");
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Radio.debugLine("pages/MainPage.ets(70:23)");
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Text.create("男");
                    Text.debugLine("pages/MainPage.ets(76:23)");
                    Text.layoutWeight(1);
                    if (!isInitialRender) {
                        Text.pop();
                    }
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Radio.debugLine("pages/MainPage.ets(77:23)");
                    Radio.onChange((isChecked) => {
                        if (isChecked) {
                            //需要执行的操作
                        }
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Text.create('女');
                    Text.debugLine("pages/MainPage.ets(83:23)");
                    Text.layoutWeight(1);
                    if (!isInitialRender) {
                        Text.pop();
                    }
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.borderRadius(commonConst.DEFAULT_10);
                ListItem.padding({ left: commonConst.DEFAULT_12, right: commonConst.DEFAULT_12 });
                ListItem.debugLine("pages/MainPage.ets(86:19)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
            ...
            const observedDeepRender = () => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("pages/MainPage.ets(87:21)");
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.borderRadius(commonConst.DEFAULT_10);
                ListItem.padding({ left: commonConst.DEFAULT_12, right: commonConst.DEFAULT_12 });
                ListItem.debugLine("pages/MainPage.ets(107:19)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
            ...
            const observedDeepRender = () => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("pages/MainPage.ets(108:23)");
                    Text.textAlign(TextAlign.Center);
                    Text.width("100%");
                    Text.height(commonConst.DEFAULT_48);
                    Text.onClick(() => {
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.borderRadius(commonConst.DEFAULT_10);
                ListItem.padding({ left: commonConst.DEFAULT_12, right: commonConst.DEFAULT_12 });
                ListItem.debugLine("pages/MainPage.ets(129:19)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
            ...
            const observedDeepRender = () => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("pages/MainPage.ets(130:21)");
                    Text.textAlign(TextAlign.Center);
                    Text.width("100%");
                    Text.height(commonConst.DEFAULT_48);
                    Text.onClick(() => {
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.borderRadius(commonConst.DEFAULT_10);
                ListItem.padding({ left: commonConst.DEFAULT_12, right: commonConst.DEFAULT_12 });
                ListItem.debugLine("pages/MainPage.ets(149:19)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
            ...
            const observedDeepRender = () => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("pages/MainPage.ets(150:21)");
                    Text.textAlign(TextAlign.Center);
                    Text.width("100%");
                    Text.height(commonConst.DEFAULT_48);
                    Text.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/MainPage.ets(173:17)");
            // .width(commonConst.THOUSANDTH_940)
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777404, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("pages/MainPage.ets(174:19)");
...
class Index extends ViewPU {
    ...
    checkCurrentTime() {
        GlobalInfoApi.query((result) => {
            ...
            if (result.length !== 0 && date.getTime() < predate.getTime()) {
                AlertDialog.show({
                    title: { "id": 16777398, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" },
                    message: { "id": 16777400, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" },
                    autoCancel: false,
                    alignment: DialogAlignment.Bottom,
                    offset: { dx: 0, dy: -20 },
                    gridCount: 3,
                    confirm: {
                        value: { "id": 16777399, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" },
                        action: () => {
    ...
    TabBuilder(index, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/MainPage.ets(273:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/MainPage.ets(274:7)");
            Image.width({ "id": 16777351, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Image.height({ "id": 16777351, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/MainPage.ets(279:7)");
            ...
            Text.margin({ top: { "id": 16777357, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" } });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Tabs.debugLine("pages/MainPage.ets(288:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("pages/MainPage.ets(290:7)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("pages/MainPage.ets(298:7)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("pages/MainPage.ets(302:7)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("pages/MainPage.ets(307:7)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
