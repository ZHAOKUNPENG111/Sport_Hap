...
export default class HealthText extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.fontSize = { "id": 16777346, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" };
        this.fontWeight = commonConst.FONT_WEIGHT_500;
        this.fontColor = { "id": 16777294, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" };
        this.fontFamily = { "id": 16777394, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" };
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/HealthTextComponent.ets(13:5)");
