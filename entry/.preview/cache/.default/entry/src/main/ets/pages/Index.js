...
class CustomDialogExample extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/Index.ets(36:5)");
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('开始运动');
            Text.debugLine("pages/Index.ets(37:7)");
            Text.fontSize(20);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("pages/Index.ets(38:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/Index.ets(39:9)");
            Button.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/Index.ets(44:9)");
            Button.onClick(() => {
                this.controller.close();
                this.confirm();
...
class EmqxPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/Index.ets(139:5)");
            Column.width("100%");
            Column.height("100%");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create("服务器连接");
            Text.debugLine("pages/Index.ets(140:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/Index.ets(146:7)");
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/Index.ets(147:7)");
            Button.width("40%");
            Button.height("10%");
            Button.margin(40);
            Button.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create("开始运动");
            Text.debugLine("pages/Index.ets(148:9)");
            Text.fontSize(20);
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Scroll.debugLine("pages/Index.ets(161:7)");
            Scroll.width("95%");
            Scroll.height("45%");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.debugLine("pages/Index.ets(162:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Text.create(item);
                    Text.debugLine("pages/Index.ets(164:13)");
                    Text.fontSize(15);
                    if (!isInitialRender) {
                        Text.pop();
                    }
