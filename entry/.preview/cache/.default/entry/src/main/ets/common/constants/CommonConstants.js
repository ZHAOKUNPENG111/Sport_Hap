...
export const NICK_NAME = '赵kp';
export const SIGNATURE = '欲买桂花同载酒，终不似，少年游';
export const HOME_BTN_Z = 2;
// time range
export const DEFAULT_TIME = '';
export const GET_UP_TIME_RANGE = '';
export const SLEEP_TIME_RANGE = '';
export const GET_UP_EARLY_TIME = '';
export const GET_UP_LATE_TIME = '';
export const SLEEP_EARLY_TIME = '';
export const SLEEP_LATE_TIME = '';
// frequency Dialog
...
export const EAT_APPLE_RANGE = 1000;
// letter spacing
