...
export class TaskCard extends ViewPU {
            ...
            if (JSON.parse(this.taskInfoStr).isDone) {
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            if (isInitialRender) {
                                ...
                                HealthText(this, { title: '' }, undefined, elmtId));
                            }
                            else {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Row.create();
                        Row.debugLine("view/home/TaskCardComponent.ets(28:7)");
                        if (!isInitialRender) {
                            Row.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("view/home/TaskCardComponent.ets(33:9)");
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/home/TaskCardComponent.ets(41:5)");
            Row.width(commonConst.THOUSANDTH_1000);
            Row.height(commonConst.THOUSANDTH_1000);
            Row.justifyContent(FlexAlign.SpaceBetween);
            Row.borderRadius({ "id": 16777351, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.debugLine("view/home/TaskCardComponent.ets(42:7)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/home/TaskCardComponent.ets(43:9)");
            ...
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ...
                if (isInitialRender) {
                    ViewPU.create(new HealthText(this, {
                        ...
                        fontFamily: { "id": 16777392, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" }
                    }, undefined, elmtId));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(elmtId, {
