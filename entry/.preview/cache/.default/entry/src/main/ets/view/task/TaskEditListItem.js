...
export class TaskChooseItem extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("view/task/TaskEditListItem.ets(46:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/task/TaskEditListItem.ets(47:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Toggle.debugLine("view/task/TaskEditListItem.ets(48:7)");
...
export class TargetSetItem extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/task/TaskEditListItem.ets(66:5)");
            Row.width(THOUSANDTH_1000);
            Row.justifyContent(FlexAlign.SpaceBetween);
            if (!isInitialRender) {
                Row.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/task/TaskEditListItem.ets(67:7)");
            Text.fontSize(DEFAULT_20);
            Text.fontWeight(FontWeight.Medium);
            if (!isInitialRender) {
                Text.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("view/task/TaskEditListItem.ets(71:7)");
            ...
            if (((_a = this.settingParams) === null || _a === void 0 ? void 0 : _a.unit) === '') {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("view/task/TaskEditListItem.ets(74:9)");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("view/task/TaskEditListItem.ets(78:9)");
                        __Text__targetSetCommon();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/task/TaskEditListItem.ets(82:7)");
...
export class OpenRemindItem extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/task/TaskEditListItem.ets(94:5)");
            Row.width(THOUSANDTH_1000);
            Row.justifyContent(FlexAlign.SpaceBetween);
            if (!isInitialRender) {
                Row.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777413, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("view/task/TaskEditListItem.ets(95:7)");
            Text.fontSize(DEFAULT_20);
            Text.fontWeight(FontWeight.Medium);
            if (!isInitialRender) {
                Text.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Toggle.debugLine("view/task/TaskEditListItem.ets(99:7)");
            Toggle.width(DEFAULT_56);
            Toggle.height(DEFAULT_32);
            Toggle.selectedColor({ "id": 16777273, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Toggle.onChange((isOn) => {
...
export class RemindTimeItem extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/task/TaskEditListItem.ets(117:5)");
            Row.width(THOUSANDTH_1000);
            Row.justifyContent(FlexAlign.SpaceBetween);
            if (!isInitialRender) {
                Row.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/task/TaskEditListItem.ets(118:7)");
            Text.fontSize(DEFAULT_20);
            Text.fontWeight(FontWeight.Medium);
            if (!isInitialRender) {
                Text.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("view/task/TaskEditListItem.ets(119:7)");
            Blank.layoutWeight(1);
            if (!isInitialRender) {
                Blank.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/task/TaskEditListItem.ets(121:7)");
            __Text__targetSetCommon();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777240, "type": 20000, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Image.debugLine("view/task/TaskEditListItem.ets(124:7)");
            Image.width(DEFAULT_8);
            Image.height(DEFAULT_16);
            if (!isInitialRender) {
                Image.pop();
...
export class FrequencyItem extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/task/TaskEditListItem.ets(137:5)");
            Row.width(THOUSANDTH_1000);
            Row.justifyContent(FlexAlign.SpaceBetween);
            if (!isInitialRender) {
                Row.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/task/TaskEditListItem.ets(139:7)");
            __Text__targetSetCommon();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777240, "type": 20000, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Image.debugLine("view/task/TaskEditListItem.ets(142:7)");
            Image.width(DEFAULT_8);
            Image.height(DEFAULT_16);
            if (!isInitialRender) {
                Image.pop();
