...
def aicoach(path, sports,aaa):
    ...
    holistic.close()
    os.kill(int(jtsd_pid), signal.SIGTERM)
    return sports
...
def video_feed():
    ...
    return Response(aicoach(-1, "static_squat",int(args)),mimetype='multipart/x-mixed-replace; boundary=frame')

# if __name__ == '__main__':
#     aicoach(int(str(1)), "static_squat")
